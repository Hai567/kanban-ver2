...
{#if $userData}
    <div style="max-width: 35em;" class="flex justify-center m-auto flex-wrap gap-6">
        ...
        <ul class="steps">
            ...
            <a class="step step-primary">Choose username</a>
            <a class="step" class:step-primary={$page.url.pathname.includes("avatar") || $page.url.pathname.includes("bio")}>Update Avatar</a>
            <a class="step" class:step-primary={$page.url.pathname.includes("bio")}>Bio</a>
        </ul>
